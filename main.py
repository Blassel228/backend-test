...
async def get_category_facets(q: Optional[str] = None, brand_ids: Optional[List[int]] = None) -> List[CategoryFacet]:
    async with AsyncSessionLocal() as session:
        ...
        return [CategoryFacet(category_id=r.category_id, category_name=r.category_name, count=r.count) for r in rows]
