...
product_category_repository_dep = Annotated[
    ProductCategoryRepository, Depends(ProductCategoryRepository)
]

product_service_dep = Annotated[ProductService, Depends(ProductService)]
product_category_dep = Annotated[
    ProductCategoryService, Depends(ProductCategoryService)
]
